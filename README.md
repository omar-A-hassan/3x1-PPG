...
## 🛠️ Tech Stack
*   **Hardware:** ESP32, IR Sensors (max30102)
...
## 👥 Contributors
*   **[NaziU]** - *Data Processing & Microservice Integration (Branch: [dev])*
*   *[omar-A-hassan]* - *Architechtural Design and Glucose Prediction Model*
